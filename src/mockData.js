...
export const REPAIR_DATA = [
  {
    ...
    issue: "leaking pipe",
    details:
      "The pipe is leaking, it as been dripping for weeks, please come fix it immediately",
    status: "reported",
  },
  {
    id: "repair-r-02",
  ...
  },
  {
    ...
    details:
      "the kitchen sink is broken, can someone do something about it, thank you",
    status: "reported",
  },
  {
    id: "repair-r-04",
    ...
    issue: "weird smell",
    details:
      "there is a weird smell coming from the toilet and it is not my shit",
    status: "fixed",
  },
];
